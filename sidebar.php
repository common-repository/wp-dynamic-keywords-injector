		...
		<div class="srx-wpdki-trial-form">
			<form method="POST" id="srx_wpdki_trial_form">
				<div class="srx-wpdki-tf-n">
					<label>Name</label>
					<input type="text" name="wpdki_trial_f_name" placeholder="First" class="wpdki_trial_f_name" required>
					<input type="text" name="wpdki_trial_l_name" placeholder="Last" class="wpdki_trial_l_name">
				</div>
				<div class="srx-wpdki-tf-e">
					<label>Email</label>
					<input type="email" name="wpdki_trial_email" class="wpdki_trial_email" required>
				</div>
				<div class="srx-wpdki-tf-w">
					<label>Website</label>
					<input type="url" name="wpdki_trial_website" class="wpdki_trial_website">
				</div>
				<div class="srx-wpdki-tf-s">
					...
					<?php wp_nonce_field('wpdki_free_trial_submit','wpdki_free_trial_nonce_field'); ?>
				</div>
			</form>
  	...
  	jQuery("#srx-close-btn").click(function(){
    	...
    	jQuery.ajax({ 
      		...
      		data:{
				...
				_srx_close_btn__nonce: <?php echo wp_json_encode( $srx_close_btn_ajax_nonce ); ?>,
    		},
    		url: ajaxurl,
